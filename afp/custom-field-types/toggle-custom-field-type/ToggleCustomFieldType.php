...
if ( ! class_exists( 'Imfs_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class Imfs_ToggleCustomFieldType extends Imfs_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.index-wp-mysql-for-speed-field' )
                    .children( '.index-wp-mysql-for-speed-checkbox-container-toggle' )
                    .hide();
