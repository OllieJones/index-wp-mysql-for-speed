 ...
 * @package     Imfs_AdminPageFramework
 */

if ( ! class_exists( 'Imfs_Select2CustomFieldType' ) ) :
/**
 ...
 */
class Imfs_Select2CustomFieldType extends Imfs_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.index-wp-mysql-for-speed-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.index-wp-mysql-for-speed-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.index-wp-mysql-for-speed-select-label' )
                .children( 'label' )
                .children( '.index-wp-mysql-for-speed-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.index-wp-mysql-for-speed-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.index-wp-mysql-for-speed-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.index-wp-mysql-for-speed-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.index-wp-mysql-for-speed-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .index-wp-mysql-for-speed-field-select2 > .index-wp-mysql-for-speed-select-label > label > .index-wp-mysql-for-speed-input-container {
    max-width: 84%;
}
