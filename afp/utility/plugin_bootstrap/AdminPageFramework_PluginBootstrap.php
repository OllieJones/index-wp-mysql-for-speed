...
abstract class Imfs_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('Imfs_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new Imfs_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
