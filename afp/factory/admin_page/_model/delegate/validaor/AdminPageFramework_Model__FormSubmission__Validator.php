...
class Imfs_AdminPageFramework_Model__FormSubmission__Validator_Base extends Imfs_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class Imfs_AdminPageFramework_Model__FormSubmission__Validator extends Imfs_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('Imfs_AdminPageFramework_Model__FormSubmission__Validator__Link', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__Import', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__Export', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'Imfs_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new Imfs_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
