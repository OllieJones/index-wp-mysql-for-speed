...
abstract class Imfs_AdminPageFramework_Model__FormSubmission_Base extends Imfs_AdminPageFramework_Form_Utility {
    ...
    class Imfs_AdminPageFramework_Model__FormSubmission extends Imfs_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new Imfs_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new Imfs_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
