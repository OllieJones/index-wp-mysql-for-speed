...
class Imfs_AdminPageFramework_Format_SubMenuPage extends Imfs_AdminPageFramework_Format_Base {
    ...
    class Imfs_AdminPageFramework_Format_SubMenuLink extends Imfs_AdminPageFramework_Format_SubMenuPage {
