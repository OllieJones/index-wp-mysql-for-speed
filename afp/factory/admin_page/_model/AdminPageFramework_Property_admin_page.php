...
class Imfs_AdminPageFramework_Property_admin_page extends Imfs_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'index-wp-mysql-for-speed') {
        ...
        $GLOBALS['aImfs_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aImfs_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aImfs_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
