...
abstract class Imfs_AdminPageFramework_Form_Utility extends Imfs_AdminPageFramework_FrameworkUtility {
    ...
    abstract class Imfs_AdminPageFramework_Form_Base extends Imfs_AdminPageFramework_Form_Utility {
    ...
    class Imfs_AdminPageFramework_Form_Model extends Imfs_AdminPageFramework_Form_Base {
        public $aArguments;
        ...
        public function getSortedInputs(array $aFormInputs) {
            ...
            $_oInputSorter = new Imfs_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
        ...
        public function dropRepeatableElements(array $aSubject) {
            $_oFilterRepeatableElements = new Imfs_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getHTTPRequestSanitized($this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type'])));
        ...
        public function _replyToRegisterFormItems() {
            ...
            $_oFieldResources = new Imfs_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
        ...
        private function _setSiteWideFieldTypeDefinitions() {
            ...
            $_oBuiltInFieldTypeDefinitions = new Imfs_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
        ...
        public function getDefaultFormValues() {
            $_oDefaultValues = new Imfs_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
            return $_oDefaultValues->get();
        }
        protected function _formatElementDefinitions(array $aSavedData) {
            $_oSectionsetsFormatter = new Imfs_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
            $this->aSectionsets = $_oSectionsetsFormatter->get();
            $_oFieldsetsFormatter = new Imfs_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
    ...
    class Imfs_AdminPageFramework_Form_View extends Imfs_AdminPageFramework_Form_Model {
        public function __construct() {
            parent::__construct();
            new Imfs_AdminPageFramework_Form_View__Resource($this);
        }
        public function get() {
            ...
            new Imfs_AdminPageFramework_Form_View___Script_Form;
            $_oFormTables = new Imfs_AdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->callBack($this->aCallbacks['field_errors'], array($this->getFieldErrors())), $this->aCallbacks, $this->oMsg);
        ...
        private function _getNoScriptMessage() {
            ...
            return "<noscript>" . "<div class='error'>" . "<p class='index-wp-mysql-for-speed-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
        }
        public function printSubmitNotices() {
            $this->oSubmitNotice->render();
        }
    }
    class Imfs_AdminPageFramework_Form_Controller extends Imfs_AdminPageFramework_Form_View {
    ...
    class Imfs_AdminPageFramework_Form extends Imfs_AdminPageFramework_Form_Controller {
        ...
        public $aSubClasses = array('submit_notice' => 'Imfs_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'Imfs_AdminPageFramework_Form___FieldError', 'last_input' => 'Imfs_AdminPageFramework_Form_Model___LastInput', 'message' => 'Imfs_AdminPageFramework_Message',);
        public function __construct() {
