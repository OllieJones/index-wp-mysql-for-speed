...
class Imfs_AdminPageFramework_Form_View___Generate_FieldTagID extends Imfs_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class Imfs_AdminPageFramework_Form_View___Generate_FieldInputID extends Imfs_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
