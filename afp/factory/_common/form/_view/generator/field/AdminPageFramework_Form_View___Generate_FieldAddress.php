...
abstract class Imfs_AdminPageFramework_Form_View___Generate_Field_Base extends Imfs_AdminPageFramework_Form_View___Generate_Section_Base {
    ...
    class Imfs_AdminPageFramework_Form_View___Generate_FieldName extends Imfs_AdminPageFramework_Form_View___Generate_Field_Base {
        public function get() {
    ...
    class Imfs_AdminPageFramework_Form_View___Generate_FlatFieldName extends Imfs_AdminPageFramework_Form_View___Generate_FieldName {
        public function get() {
    ...
    class Imfs_AdminPageFramework_Form_View___Generate_FieldAddress extends Imfs_AdminPageFramework_Form_View___Generate_FlatFieldName {
        public function get() {
