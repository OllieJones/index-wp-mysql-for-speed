...
class Imfs_AdminPageFramework_Form_View___Script_MediaUploader extends Imfs_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getImfs_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
