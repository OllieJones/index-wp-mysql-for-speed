...
class Imfs_AdminPageFramework_Form_View___Script_Base extends Imfs_AdminPageFramework_Factory___Script_Base {
    }
    class Imfs_AdminPageFramework_Form_View___Script_AttributeUpdator extends Imfs_AdminPageFramework_Form_View___Script_Base {
