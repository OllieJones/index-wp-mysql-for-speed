...
(function ( $ ) {
     ...
     */  
    $( document ).bind( 'index-wp-mysql-for-speed_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
     ...
     */
    $( document ).bind( 'index-wp-mysql-for-speed_repeated_field', function( oEvent, iCallType, oModelContainer ){
     ...
     * @since       3.8.0
     */
    $( document ).bind( 'index-wp-mysql-for-speed_stopped_sorting_sections', function( oEvent ){  
     ...
     */
    /* $( document ).bind( 'index-wp-mysql-for-speed_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
     ...
     * @since    3.2.0 
     */
    $( document ).bind( 'index-wp-mysql-for-speed_saved_widget', function( event, oWidget ){
