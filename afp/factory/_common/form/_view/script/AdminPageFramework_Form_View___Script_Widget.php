...
class Imfs_AdminPageFramework_Form_View___Script_Widget extends Imfs_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.index-wp-mysql-for-speed-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'index-wp-mysql-for-speed_saved_widget', 
                    _oWidget 
                );
