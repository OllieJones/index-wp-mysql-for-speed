...
class Imfs_AdminPageFramework_Form_View___Script_SectionTab extends Imfs_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.index-wp-mysql-for-speed-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='index-wp-mysql-for-speed-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
