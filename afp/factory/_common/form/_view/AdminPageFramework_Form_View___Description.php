...
class Imfs_AdminPageFramework_Form_View___Description extends Imfs_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'index-wp-mysql-for-speed-form-element-description';
