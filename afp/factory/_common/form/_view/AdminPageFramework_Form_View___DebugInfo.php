...
class Imfs_AdminPageFramework_Form_View___DebugInfo extends Imfs_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='index-wp-mysql-for-speed-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
