...
class Imfs_AdminPageFramework_Form_Model___SetFieldResources extends Imfs_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new Imfs_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('Imfs_AdminPageFramework_Form_View___CSS_Form', 'Imfs_AdminPageFramework_Form_View___CSS_Field', 'Imfs_AdminPageFramework_Form_View___CSS_Section', 'Imfs_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'Imfs_AdminPageFramework_Form_View___CSS_FieldError', 'Imfs_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('Imfs_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new Imfs_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new Imfs_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
