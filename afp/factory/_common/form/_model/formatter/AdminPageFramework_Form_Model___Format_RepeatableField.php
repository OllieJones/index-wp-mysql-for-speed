...
class Imfs_AdminPageFramework_Form_Model___Format_RepeatableSection extends Imfs_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : Imfs_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class Imfs_AdminPageFramework_Form_Model___Format_RepeatableField extends Imfs_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
