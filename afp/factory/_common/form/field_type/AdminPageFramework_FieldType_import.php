...
class Imfs_AdminPageFramework_FieldType_import extends Imfs_AdminPageFramework_FieldType_submit {
...
jQuery( document ).ready( function() {
    jQuery( '.index-wp-mysql-for-speed-field-import input[type=submit]' ).on( 'click', function( event ) {
        var _iFiles = jQuery( this ).closest( '.index-wp-mysql-for-speed-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".index-wp-mysql-for-speed-field-import input {margin-right: 0.5em;}.index-wp-mysql-for-speed-field-import,.index-wp-mysql-for-speed-field-import .index-wp-mysql-for-speed-input-label-container {width: 100%;}.index-wp-mysql-for-speed-field-import label,.form-table td fieldset.index-wp-mysql-for-speed-fieldset .index-wp-mysql-for-speed-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
