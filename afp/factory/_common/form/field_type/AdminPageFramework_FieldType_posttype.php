...
class Imfs_AdminPageFramework_FieldType_checkbox extends Imfs_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllImfs_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllImfs_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.index-wp-mysql-for-speed-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.index-wp-mysql-for-speed-checkbox-label {margin-top: 0.1em;}.index-wp-mysql-for-speed-field input[type='checkbox' ] {margin-right: 0.5em;} .index-wp-mysql-for-speed-field-checkbox .index-wp-mysql-for-speed-input-label-container {padding-right: 1em;}.index-wp-mysql-for-speed-field-checkbox .index-wp-mysql-for-speed-input-label-string{display: inline; }";
    }
    ...
    class Imfs_AdminPageFramework_FieldType_posttype extends Imfs_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".index-wp-mysql-for-speed-field input[type='checkbox'] {margin-right: 0.5em;} .index-wp-mysql-for-speed-field-posttype .index-wp-mysql-for-speed-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
