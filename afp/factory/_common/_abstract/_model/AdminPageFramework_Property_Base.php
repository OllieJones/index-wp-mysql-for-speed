...
abstract class Imfs_AdminPageFramework_Property_Base extends Imfs_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'index-wp-mysql-for-speed' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aImfs_AdminPageFramework'])) {
            $GLOBALS['aImfs_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => Imfs_AdminPageFramework_Registry::NAME, 'sURI' => Imfs_AdminPageFramework_Registry::URI, 'sScriptName' => Imfs_AdminPageFramework_Registry::NAME, 'sLibraryName' => Imfs_AdminPageFramework_Registry::NAME, 'sLibraryURI' => Imfs_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => Imfs_AdminPageFramework_Registry::getVersion(), 'sDescription' => Imfs_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => Imfs_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => Imfs_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => Imfs_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => Imfs_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
