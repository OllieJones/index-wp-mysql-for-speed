...
abstract class Imfs_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'Imfs_AdminPageFramework_Form_', 'oPageLoadInfo' => 'Imfs_AdminPageFramework_PageLoadInfo_', 'oResource' => 'Imfs_AdminPageFramework_Resource_', 'oHelpPane' => 'Imfs_AdminPageFramework_HelpPane_', 'oLink' => 'Imfs_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'Imfs_AdminPageFramework_Debug', 'oUtil' => 'Imfs_AdminPageFramework_FrameworkUtility', 'oMsg' => 'Imfs_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(Imfs_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return Imfs_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class Imfs_AdminPageFramework_Factory_Model extends Imfs_AdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class Imfs_AdminPageFramework_Factory_View extends Imfs_AdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new Imfs_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class Imfs_AdminPageFramework_Factory_Controller extends Imfs_AdminPageFramework_Factory_View {
    ...
    abstract class Imfs_AdminPageFramework_Factory extends Imfs_AdminPageFramework_Factory_Controller {
    }
