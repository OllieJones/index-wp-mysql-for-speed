...
class Imfs_AdminPageFramework_AdminNotice extends Imfs_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'index-wp-mysql-for-speed-settings-notice-message', 'index-wp-mysql-for-speed-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new Imfs_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
