...
class Imfs_AdminPageFramework_AdminNotice___Script extends Imfs_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.index-wp-mysql-for-speed-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='index-wp-mysql-for-speed-admin-notice-animation-container'></div>" );
