...
abstract class Imfs_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        Imfs_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return Imfs_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        Imfs_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return Imfs_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        Imfs_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        Imfs_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        Imfs_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'Imfs_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class Imfs_AdminPageFramework_Utility_String extends Imfs_AdminPageFramework_Utility_VariableType {
    ...
    abstract class Imfs_AdminPageFramework_Utility_Array extends Imfs_AdminPageFramework_Utility_String {
    ...
    abstract class Imfs_AdminPageFramework_Utility_ArrayGetter extends Imfs_AdminPageFramework_Utility_Array {
    ...
    abstract class Imfs_AdminPageFramework_Utility_ArraySetter extends Imfs_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class Imfs_AdminPageFramework_Utility_Path extends Imfs_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class Imfs_AdminPageFramework_Utility_URL extends Imfs_AdminPageFramework_Utility_Path {
    ...
    abstract class Imfs_AdminPageFramework_Utility_File extends Imfs_AdminPageFramework_Utility_URL {
    ...
    abstract class Imfs_AdminPageFramework_Utility_SystemInformation extends Imfs_AdminPageFramework_Utility_File {
    ...
    abstract class Imfs_AdminPageFramework_Utility_HTMLAttribute extends Imfs_AdminPageFramework_Utility_SystemInformation {
    ...
    class Imfs_AdminPageFramework_Utility extends Imfs_AdminPageFramework_Utility_HTMLAttribute {
